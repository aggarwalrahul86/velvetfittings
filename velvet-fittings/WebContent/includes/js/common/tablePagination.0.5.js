 ...
 */
 ...
 /*$(document).ready(function(){
	//$('tbody tr:odd', $('#rsrcMpngResourceListTbl')).hide(); //hiding rows for test
    var options = {
      currPage : 1, 
    //  ignoreRows : $('tbody tr:odd', $('#rsrcMpngResourceListTbl')),
      optionsForRows : [2,3,5],
      rowsPerPage : 5,
      firstArrow : (new Image()).src="../includes/images/grid/first.gif",
      prevArrow : (new Image()).src="../includes/images/grid/prev.gif",
      lastArrow : (new Image()).src="../includes/images/grid/last.gif",
      nextArrow : (new Image()).src="../includes/images/grid/next.gif",
      topNav : false
    }
    $('#rsrcMpngResourceListTbl').tablePagination(options);
...
$.fn.tablePagination = function(settings) {
	var defaults = {  
		...
		//lastArrow : (new Image()).src="./images/next.gif",
		//nextArrow : (new Image()).src="./images/last.gif",
		//rowsPerPage : 5,
		currPage : 1,
