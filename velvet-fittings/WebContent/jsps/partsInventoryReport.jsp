	...
	<form:form commandName="partsSearch" action=""
		...
		<div id="inrPgBdCntntSearchProgram">
			<div class="inrPgBdCntntBorder">
				...
				<div class="inrPgTbCntntTtl">Parts Search Screen</div>
				...
				<div class="clrFlts"></div>
				<div class="bdHPd"></div>
				<div class="nTpPdng edtPrjLbl">
					<label>From Date</label>
				</div>
				<div class="inrPgBdElmt">
					<form:input path="fromDate"
						cssClass="vlvtSmallTextBox" id="partFromDate" title="From Date"/>
				</div>
				<div class="edtPrjMdPd"></div>
				<div class="nTpPdng edtPrjLbl">
					<label>To Date</label>
				</div>
				<div class="inrPgBdElmt">
					<form:input path="toDate"
						cssClass="vlvtSmallTextBox" id="partToDate" title="To Date"/>
				</div>
				<div class="clrFlts"></div>
				<div class="bdHPd"></div>
				...
				<div id="inrPgBdCntntPartsSearchResults" >
		             <jsp:include page="partsSearchResultsList.jsp"></jsp:include>
	           </div>
			</div>
		</div>
